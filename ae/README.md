...
scaling knobs and what cannot be reproduced — is the artifact appendix in this directory: [`APPENDIX.md`](APPENDIX.md).

This directory is the evaluation harness itself:

    ae.sh              the only thing you run on the host
    ae_ondevice.sh     Table III, needs phones over adb (§6 of APPENDIX.md)
