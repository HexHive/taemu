# AUTO-GENERATED generic mutational fuzz harness for KEYMST (4b45594d5354).
from .params import *
from qiling import Qiling
import struct

GATE_PTYPES = 0x65
CMDS = [10,14,15,16,17,18,30,40,42,43]
SIZE_CHOICES = [0,1,4,16,64,0x100,0x400,0x1000,0x2000]        # includes the TA's documented exact memref sizes
