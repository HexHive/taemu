# AUTO-GENERATED generic mutational fuzz harness for gatekeeper (474154454b45).
from .params import *
...
GATE_PTYPES = 0x557
CMDS = [126,63]
SIZE_CHOICES = [0x419,0x419,0x3a,0x3a,0x419,0x3a,0x100,0x80,0x40,0x418,0x41a,0x39]        # includes the TA's documented exact memref sizes
