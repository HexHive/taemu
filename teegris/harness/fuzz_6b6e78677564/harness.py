# AUTO-GENERATED generic mutational fuzz harness for knxgud (6b6e78677564).
from .params import *
from qiling import Qiling
import struct

GATE_PTYPES = 0x67
CMDS = [0x10A,0x102,0x107,0x117,0x116,0x100,0x101,0x103,0x104,0x113]
SIZE_CHOICES = [0x4440,0x4440,0x4440,0x4440,0x4440,0x4440,0x443f,0x4441,0x1000]        # includes the TA's documented exact memref sizes
