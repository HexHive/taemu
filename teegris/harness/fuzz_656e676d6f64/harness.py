# AUTO-GENERATED generic mutational fuzz harness for engmod (656e676d6f64).
from .params import *
from qiling import Qiling
import struct

GATE_PTYPES = 0x77
CMDS = [11,12,13,17,24,32,33,34]
SIZE_CHOICES = [0,1,4,16,64,0x100,0x1000,0x20936,0x21c7d]        # includes the TA's documented exact memref sizes
